...
public class BoardRespDto {
  ...
  public static class BoardDetailRespDto {
    ...
    private String title;
    private String content;
    private BoardUserDto user; // 글을 쓴 user
    ...
    public static class CommentDto {
      private Long id;
      private String content;
      private CommentUserDto user; // 댓글을 쓴 user

      public CommentDto(Comment comment) { // comment를 commentDto로 변환하기 위한 생성자
    ...
    public BoardDetailRespDto(Board board) {
      ...
      // this.comment = new board.getComments();
      // 바로 넣어주면 commentDto List vs comment List 타입이 달라서 오류나기 때문에
